...
def test_phase5_policy_never_enables_modes(tmp_path: Path) -> None:
    phase4 = {
        "phase": 4,
        "asof": "i60",
        "grid": "GRID_TEST",
    ...
    pl = it["intent_payload"]
    assert pl["arbitrage"]["enabled"] is False
    assert pl["directional"]["enabled"] is False
    assert pl["flashloan"]["enabled"] is False
