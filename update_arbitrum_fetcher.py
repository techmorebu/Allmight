#!/usr/bin/env python3
"""
Rewrites arbitrumFetcher.js with all verified pool addresses from factory discovery.
Key additions: stablecoin pools with 0.01% fees (1 bps) -- fee wall drops to 2 bps.

Run: python3 update_arbitrum_fetcher.py
"""
import os
...
CONTENT = r"""// arbitrumFetcher.js v2.0
...
const UNISWAP_V3_POOLS = [
    ...
    },
    {
        ...
        decimals1:  6,    // USDC
        fee:        100,
        priceMode:  'direct',  // USDC per DAI (~1.0)
    },
    {
        outputPair: 'DAI/USDT',
