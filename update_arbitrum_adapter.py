#!/usr/bin/env python3
"""
Updates arbitrum.py adapter to also load curveFetcherArbitrum data
from Redis key: fetcher:curveFetcherArbitrum

Run: python3 update_arbitrum_adapter.py
"""
import os

TARGET = os.path.expanduser(
    "~/Allmight/scripts/market/redis_adapters/arbitrum.py"
)
...
print("Now handles both arbitrumFetcher and curveFetcherArbitrum keys")
