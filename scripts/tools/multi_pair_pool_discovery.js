...
const VENUES = [
  ...
  },
  {
    ...
    factory: process.env.ARB_RAMSES_V2_FACTORY || '0xAA2cd7477c451E703f3B9Ba5663334914763edF8',
    slotFn : 'slot0',
    // Ramses V2 supports non-standard fee tiers — standard UniV3 tiers not all registered.
    // Confirmed active: 250, 500, 3000, 10000. Reverts on: 50, 100, 2500.
    feeTiers: [250, 500, 3000, 10000],
  },
];
