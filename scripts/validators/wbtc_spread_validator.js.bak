// scripts/tools/wbtc_spread_validator.js
...
//
// Usage:
//   node -r dotenv/config scripts/tools/wbtc_spread_validator.js
//   node -r dotenv/config scripts/tools/wbtc_spread_validator.js --samples 20 --interval 8000
