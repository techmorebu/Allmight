// scripts/tools/arb_slippage_model.js
...
//
// Usage:
//   node -r dotenv/config scripts/tools/arb_slippage_model.js
//   node -r dotenv/config scripts/tools/arb_slippage_model.js --runs 3
