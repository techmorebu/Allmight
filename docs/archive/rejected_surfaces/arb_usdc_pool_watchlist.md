...
<!-- STATUS: SURFACE REJECTED | Last updated: 2026-03-28 -->
<!-- Owner: CPT | Authority: Boss ruling 2026-03-28 -->

## Surface Verdict: ❌ REJECTED (2026-03-28)

**Session window:** 2026-03-28T08:22–20:14 UTC (713 min, 141 scans)

| Metric | Required | Actual | Result |
|---|---|---|---|
| min priceDistanceBps | < 500 | 961.5 | ❌ |
| max depthMin | ≥ $10,000 | $4,350 | ❌ |
| max consecutive ≥$10k | ≥ 3 scans | 0 | ❌ |

**Reason:** The market never came to the zone. No approach, no liquidity, no activation — across the full observation window.

**Status:** `REJECTED (regime-dependent)` — not forever dead, but not actionable under current market conditions. Pivot to WBTC/USDC initiated.

**Repo action:** This file moves to `docs/archive/rejected_surfaces/` after commit.
