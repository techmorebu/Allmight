#!/usr/bin/env python3
"""
Patch: wires real preflight + real V2 simulator into run_reality_check.py
Also adds near-miss reporting so zero-candidate runs show WHY.

Run from project root: python3 write_patch_rc1_wiring.py
"""
import os
...
print("   - Real preflight wired (PreflightPolicyV1 + GasModelV1)")
print("   - Real V2 simulator wired (simulate_route + V2PoolState)")
print("   - Near-miss reporting added (shows fee-killed candidates with exact numbers)")
print("   - Gas estimator reads oracle threshold table")
print("")
print("Run:")
print("  node scripts/master-fetcher.js once && python3 scripts/run_reality_check.py --single --tier 1000")
